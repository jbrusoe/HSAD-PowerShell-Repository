# Confirm-ValidCertficate.ps1
# Written by: Jeff Brusoe
# Last Updated: August 18, 20201
#
# https://tech.nicolonsky.ch/monitor-apple-token-expiration-in-intune/
# https://msendpointmgr.com/2018/03/26/monitoring-apple-mdm-push-certificates-in-microsoft-intune-with-powershell/
...
Param(
    ...
    [int]$NotificationThresholdDays = 21
)

Write-Output "Notification Threshold Days: $NotificationThresholdDays"
<#
