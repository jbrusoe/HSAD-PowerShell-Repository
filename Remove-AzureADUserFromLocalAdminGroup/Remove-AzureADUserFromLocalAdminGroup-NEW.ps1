...
#Note: Set-HSCEnvironment isn't used here since this file probably won't have
#access to it when it is being run.
Clear-Host
$Error.Clear()
...
$TranscriptLogFile = $LogFileDirectory +
...
if (($AADAccounts | Measure-Object).count -gt 0)
{
