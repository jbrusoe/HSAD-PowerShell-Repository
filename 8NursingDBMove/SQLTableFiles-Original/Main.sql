...
BEGIN
ALTER TABLE [HSC\srodman].[MAIN] DROP CONSTRAINT [DF__MAIN__citizenshi__0A3E6E7F]
END
...
BEGIN
ALTER TABLE [HSC\srodman].[MAIN] DROP CONSTRAINT [DF__MAIN__citizenshi__0B3292B8]
END
...
BEGIN
ALTER TABLE [HSC\srodman].[MAIN] DROP CONSTRAINT [DF__MAIN__currently __0C26B6F1]
END
...
BEGIN
ALTER TABLE [HSC\srodman].[MAIN] DROP CONSTRAINT [DF__MAIN__disability__0D1ADB2A]
END
...
BEGIN
ALTER TABLE [HSC\srodman].[MAIN] DROP CONSTRAINT [DF__MAIN__military__0E0EFF63]
END
...
BEGIN
ALTER TABLE [HSC\srodman].[MAIN] DROP CONSTRAINT [DF__MAIN__country of__0F03239C]
END
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[HSC\srodman].[MAIN]') AND type in (N'U'))
DROP TABLE [HSC\srodman].[MAIN]
GO
...
ALTER TABLE [HSC\srodman].[MAIN] ADD  DEFAULT ('USA') FOR [citizenship]
GO

ALTER TABLE [HSC\srodman].[MAIN] ADD  DEFAULT ('US Citizen') FOR [citizenship_status]
GO

ALTER TABLE [HSC\srodman].[MAIN] ADD  DEFAULT (0) FOR [currently married]
GO

ALTER TABLE [HSC\srodman].[MAIN] ADD  DEFAULT ('None stated') FOR [disability]
GO

ALTER TABLE [HSC\srodman].[MAIN] ADD  DEFAULT ('N/A') FOR [military]
GO

ALTER TABLE [HSC\srodman].[MAIN] ADD  DEFAULT ('USA') FOR [country of birth]
GO
