...
$ModuleParamaters = @{
    Path = "C:\Users\$($LoggedOnUser.Username.Split('\')[1])\Documents\GitHub\HSC-PowerShell-Repository\1HSCCustomModules\$ModuleName"
...
{    
    if (Test-Path -Path "C:\Users\$($LoggedOnUser.Username.Split('\')[1])\Documents\GitHub\HSC-PowerShell-Repository\1HSCCustomModules\")
    {
