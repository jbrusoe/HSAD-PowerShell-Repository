$users = get-qaduser -sizelimit 0 -includedproperties useraccountcontrol -searchroot "hs.wvu-ad.wvu.edu/hsc/SOP"

New-Item -name "UAC7.csv" -type file -force
$count = 0
...
foreach ($user in $users)
{
	...
	else
	{
		...
		Add-Content UAC7.csv -value $Output
	}
