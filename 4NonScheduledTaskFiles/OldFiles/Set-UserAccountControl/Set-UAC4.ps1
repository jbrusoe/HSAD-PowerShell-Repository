$users = get-qaduser -sizelimit 0 -includedproperties useraccountcontrol -searchroot "hs.wvu-ad.wvu.edu/hsc/SON"

New-Item -name "UAC4a.csv" -type file -force
$count = 0
...
foreach ($user in $users)
{
	...
	else
	{
		...
		Add-Content UAC4a.csv -value $Output
	}
